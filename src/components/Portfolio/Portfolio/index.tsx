      ...
      <div className="md:px-10 flex justify-center">
        <div className="">
          <div className="grid grid-cols-1 md:grid-cols-2 px-3 gap-5 justify-items-center">
            <ProjectCard data={PortfolioWebsiteProjects[0]} />
            ...
            "
                >
                  <div className="flex justify-between py-2 items-center w-full z-10">
                    ...
                    <DisableLink isDisabled href="/" className="py-1 px-3 bg-primary rounded-lg font-medium ">
                  ...
                  <div className="flex flex-col gap-2 justify-between py-2 w-full z-10">
                    ...
                    <Paragraph level={5} className="">
                      ...
                      "De Minibus Nongourmet Dolores'' after mixing the words in
                      each sentence. They abbreviated the word Dolores, which
                      means pain.
                    </Paragraph>
                  </div>
                </div>
