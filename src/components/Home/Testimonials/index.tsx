...
export default function TestimonialsSection() {
  return (
    <SectionHeader button="Testimonials" heading="What Our Clients Say">
      <div className="h-[90%] flex justify-center lg:px-[10rem] xl:px-[15rem]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-3 content-center">
          <div className="flex flex-col rounded-2xl p-3 md:p-6 max-w-[25rem] border md:border-0 gap-2 md:gap-4">
