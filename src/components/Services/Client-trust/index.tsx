...
export default function ClientTrustSection() {
  return (
    <SectionHeader button="Our Services" heading="Swift and Dependable Software Performance" paragraph="We blend innovation with experience to deliver outstanding digital solutions. Our expert team is dedicated to understanding your unique needs.">
